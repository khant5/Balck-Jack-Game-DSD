module random2(switch,CLOCK_50, Preset,p);
...
//random generator start at sequncce 4'b1001, because it needs to start other than state zero.
if(Preset==1) y<=4'b1001;
