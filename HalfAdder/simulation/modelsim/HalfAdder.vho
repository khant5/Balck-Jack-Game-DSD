...
-- carry	=>  Location: PIN_G19,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \Mult0~0_combout\ : std_logic;
...
\Mult0~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \Mult0~0_combout\ = (\b~input_o\ & \a~input_o\)
