module bcdAdder2(a8_in, b8_in, sum12_out, cout8_out, cin8_in,a,b,add,sum8_out);
	...
	//assign sum12_out[7:0]=sum12_out[7:0]-7'b0000001;
	assign sum8_out[7:0]= sum12_out[7:0]-7'b0000001;
	//assign sum12_out[7:0]= sum8_out[7:0];
	always @(posedge add)
	begin
